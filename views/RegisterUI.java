...
public class RegisterUI extends jFrame {
    ...
    public RegisterUI() {
        ...
        langButton.setForeground(guiCons.lightpink);
        ...
        fnameLabel = new jlabel(LanguageManager.t("first_name"), 16, guiCons.White, Font.PLAIN);
        lnameLabel = new jlabel(LanguageManager.t("last_name"), 16, guiCons.White, Font.PLAIN);
        emailLabel = new jlabel(LanguageManager.t("email"), 16, guiCons.White, Font.PLAIN);
        passwordLabel = new jlabel(LanguageManager.t("password"), 16, guiCons.White, Font.PLAIN);
        ...
        buttonsPanel.setBackground(guiCons.pink);
